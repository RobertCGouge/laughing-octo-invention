defmodule LaughingOctoInventionWeb.Router do
  use LaughingOctoInventionWeb, :router
  ...
  # scope "/api", LaughingOctoInventionWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: LaughingOctoInventionWeb.Telemetry
    end
  end
